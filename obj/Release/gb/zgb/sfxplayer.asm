...
;--------------------------------------------------------
	.area _HOME
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/sfxplayer.c:18: UINT8 sfx_play_isr(void) NONBANKED NAKED {
;	---------------------------------
; Function sfx_play_isr
; ---------------------------------
_sfx_play_isr::
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/sfxplayer.c:144: __endasm;
	.macro	copy_reg ?lbl
	sla	b
	jr	nc, lbl
	ld	a, (hl+)
...
0$:
	...
	ld	a, d ; result in a
	ret
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/sfxplayer.c:153: }
	.area _HOME
;--------------------------------------------------------
; code
;--------------------------------------------------------

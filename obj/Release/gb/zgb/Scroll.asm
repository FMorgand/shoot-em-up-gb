...
_scroll_cptr::
	.ds 2
_ScrollUpdateRow___save_10001_344:
	.ds 1
_ScrollUpdateColumn___save_10001_357:
	.ds 1
_MoveScroll_current_column_10000_367:
	.ds 2
_MoveScroll_new_column_10000_367:
	.ds 2
_MoveScroll_current_row_10000_367:
	.ds 2
_MoveScroll_new_row_10000_367:
	.ds 2
_MoveScroll___save_10000_367:
	.ds 1
;--------------------------------------------------------
; ram data
;--------------------------------------------------------
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:252: scroll_ptr = pending_w_map;
	...
	ld	(#_scroll_ptr + 1),a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:256: scroll_cptr = NULL;
	xor	a, a
	ld	hl, #_scroll_cptr
	ld	(hl+), a
	ld	(hl), a
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:283: scroll_ptr = scroll_map + offset;
	...
	adc	a, b
	ld	(#_scroll_ptr + 1),a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:287: scroll_cptr = NULL;
	xor	a, a
	ld	hl, #_scroll_cptr
	ld	(hl+), a
	ld	(hl), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:291: __save = CURRENT_BANK;
	ldh	a, (__current_bank + 0)
	ld	(#_ScrollUpdateRow___save_10001_344),a
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:300: SWITCH_ROM(__save);
	ld	a, (_ScrollUpdateRow___save_10001_344)
	ldh	(__current_bank + 0), a
	ld	(#_rROMB0),a
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:304: scroll_ptr = pending_h_map;
	...
	ld	(#_scroll_ptr + 1),a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:308: scroll_cptr = NULL;
	xor	a, a
	ld	hl, #_scroll_cptr
	ld	(hl+), a
	ld	(hl), a
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:335: scroll_ptr = scroll_map + offset;
	...
	adc	a, b
	ld	(#_scroll_ptr + 1),a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:339: scroll_cptr = NULL;
	xor	a, a
	ld	hl, #_scroll_cptr
	ld	(hl+), a
	ld	(hl), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:343: __save = CURRENT_BANK;
	ldh	a, (__current_bank + 0)
	ld	(#_ScrollUpdateColumn___save_10001_357),a
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:352: SWITCH_ROM(__save);
	ld	a, (_ScrollUpdateColumn___save_10001_357)
	ldh	(__current_bank + 0), a
	ld	(#_rROMB0),a
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:370: __save = CURRENT_BANK;
	ldh	a, (__current_bank + 0)
	ld	(#_MoveScroll___save_10000_367),a
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:373: current_column = PX_TO_TILE(scroll_x);
	ld	a, (#_scroll_x)
	ld	(#_MoveScroll_current_column_10000_367),a
	ld	a, (#_scroll_x + 1)
	ld	hl, #_MoveScroll_current_column_10000_367 + 1
	ld	(hl), a
	sra	(hl)
	dec	hl
	rr	(hl)
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:374: current_row    = PX_TO_TILE(scroll_y);
	ld	a, (#_scroll_y)
	ld	(#_MoveScroll_current_row_10000_367),a
	ld	a, (#_scroll_y + 1)
	ld	hl, #_MoveScroll_current_row_10000_367 + 1
	ld	(hl), a
	sra	(hl)
	dec	hl
	rr	(hl)
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:380: new_column     = PX_TO_TILE(scroll_x);
	ld	a, (#_scroll_x)
	ld	(#_MoveScroll_new_column_10000_367),a
	ld	a, (#_scroll_x + 1)
	ld	hl, #_MoveScroll_new_column_10000_367 + 1
	ld	(hl), a
	sra	(hl)
	dec	hl
	rr	(hl)
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:381: new_row        = PX_TO_TILE(scroll_y);
	ld	a, (#_scroll_y)
	ld	(#_MoveScroll_new_row_10000_367),a
	ld	a, (#_scroll_y + 1)
	ld	hl, #_MoveScroll_new_row_10000_367 + 1
	ld	(hl), a
	sra	(hl)
	dec	hl
	rr	(hl)
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:383: if (current_column != new_column) {
	ld	a, (#_MoveScroll_current_column_10000_367)
	ld	hl, #_MoveScroll_new_column_10000_367
	sub	a, (hl)
	jr	NZ, 00168$
	ld	a, (#_MoveScroll_current_column_10000_367 + 1)
	ld	hl, #_MoveScroll_new_column_10000_367 + 1
	sub	a, (hl)
	jr	Z, 00105$
00168$:
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:391: if (current_row != new_row) {
	ld	a, (#_MoveScroll_current_row_10000_367)
	ld	hl, #_MoveScroll_new_row_10000_367
	sub	a, (hl)
	jr	NZ, 00171$
	ld	a, (#_MoveScroll_current_row_10000_367 + 1)
	ld	hl, #_MoveScroll_new_row_10000_367 + 1
	sub	a, (hl)
	jr	Z, 00112$
00171$:
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:392: if (new_row > current_row) {
	ld	de, #_MoveScroll_current_row_10000_367
	ld	hl, #_MoveScroll_new_row_10000_367
	ld	a, (de)
	inc	de
	sub	a, (hl)
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:405: SWITCH_ROM(__save);
	ld	a, (_MoveScroll___save_10000_367)
	ldh	(__current_bank + 0), a
	ld	(#_rROMB0),a

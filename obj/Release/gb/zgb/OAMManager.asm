...
; ---------------------------------
_SwapOAMs::
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/OAMManager.c:32: hide_sprites_range(next_oam_idx, MAX_HARDWARE_SPRITES);
	ld	e, #0x28
	ld	a, (_next_oam_idx)
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/OAMManager.c:46: next_oam_idx = 0;
	xor	a, a
	ld	(#_next_oam_idx),a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/OAMManager.c:50: InitOAMs();

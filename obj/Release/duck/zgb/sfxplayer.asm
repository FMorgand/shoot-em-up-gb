...
;--------------------------------------------------------
	.area _HOME
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/duck/sfxplayer.c:18: UINT8 sfx_play_isr(void) NONBANKED NAKED {
;	---------------------------------
; Function sfx_play_isr
; ---------------------------------
_sfx_play_isr::
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/duck/sfxplayer.c:194: __endasm;
...
0$:
	...
	ld	a, d ; result in a
	ret
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/duck/sfxplayer.c:203: }
	.area _HOME
;--------------------------------------------------------
; code
;--------------------------------------------------------

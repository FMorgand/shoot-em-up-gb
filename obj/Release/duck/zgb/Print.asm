...
_font_tiledata_bank::
	.ds 1
_Printf_tmp_10000_264:
	.ds 10
_Printf_old_x_10000_264:
	.ds 1
;--------------------------------------------------------
; ram data
;--------------------------------------------------------
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Print.c:75: SWITCH_ROM(font_tiledata_bank);
	...
	ldh	(__current_bank + 0), a
	ld	(#_rROMB0),a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Print.c:77: set_native_tile_data(font_current_offset, 1, font_tiledata + ((UINT16)c << 4));
	ld	l, b
	ld	h, #0x00
	add	hl, hl
	add	hl, hl
	...
	ld	b, a
;c:\users\franc\documents\projets\perso\gameboyprojects\gbdk\include\gb\gb.h:2145: if (first_tile < 256) {
;c:\users\franc\documents\projets\perso\gameboyprojects\gbdk\include\gb\gb.h:2146: set_bkg_data(first_tile, nb_tiles, data);
;c:\users\franc\documents\projets\perso\gameboyprojects\gbdk\include\gb\gb.h:2145: if (first_tile < 256) {
...
;c:\users\franc\documents\projets\perso\gameboyprojects\gbdk\include\gb\gb.h:2146: set_bkg_data(first_tile, nb_tiles, data);
	...
	jr	00124$
00122$:
;c:\users\franc\documents\projets\perso\gameboyprojects\gbdk\include\gb\gb.h:2148: set_sprite_data(first_tile - 256, nb_tiles, data);
	push	de
	ld	a, #0x01
	push	af
	inc	sp
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Print.c:85: SWITCH_ROM(__save);
	...
	ld	hl, #_rROMB0
	ld	(hl), c
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Print.c:88: if(print_target == PRINT_BKG)
	ld	a, (#_print_target)
	or	a, a
	jr	NZ, 00110$
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Print.c:90: UpdateMapTile(print_target, print_x + scroll_offset_x, print_y + scroll_offset_y, font_current_offset, 0, NULL);
	...
	jr	00111$
00110$:
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Print.c:93: UpdateMapTile(print_target, print_x, print_y, font_current_offset, 0, NULL);
	ld	de, #0x0000
	push	de
	xor	a, a
	push	af
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Print.c:95: font_current_offset++;
	...
	jr	00117$
00116$:
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Print.c:98: if(print_target == PRINT_BKG)
	ld	a, (#_print_target)
	or	a, a
	jr	NZ, 00113$
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Print.c:100: UpdateMapTile(print_target, print_x + scroll_offset_x, print_y + scroll_offset_y, font_offset, c, NULL);
	...
	jr	00117$
00113$:
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Print.c:103: UpdateMapTile(print_target, print_x, print_y, font_offset, c, NULL);
	ld	de, #0x0000
	push	de
	push	bc
	inc	sp

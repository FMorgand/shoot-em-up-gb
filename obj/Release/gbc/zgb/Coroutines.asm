...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Coroutines.c:130: *stack = (uint16_t)user_data;
	...
	ld	(hl+), a
	ld	(hl), d
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Coroutines.c:132: stack = (uint16_t *)((uint8_t *)stack - 6); // match SM83 banked call convention
	ld	a, c
	add	a, #0xfa
	ld	c, a
	ld	a, b
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Coroutines.c:139: *stack = (uint16_t *)coro;
	...
	ld	(hl+), a
	ld	(hl), d
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Coroutines.c:141: *--stack = coro_bank << 8;                  // coroutine bank
	dec	bc
	dec	bc
	ldhl	sp,	#6
	ld	d, (hl)

...
_scroll_cptr::
	.ds 2
_ScrollUpdateRow___save_10001_357:
	.ds 1
_ScrollUpdateColumn___save_10001_372:
	.ds 1
_MoveScroll_current_column_10000_383:
	.ds 2
_MoveScroll_new_column_10000_383:
	.ds 2
_MoveScroll_current_row_10000_383:
	.ds 2
_MoveScroll_new_row_10000_383:
	.ds 2
_MoveScroll___save_10000_383:
	.ds 1
;--------------------------------------------------------
; ram data
;--------------------------------------------------------
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:80: palette_entries = tiles->color_data;
	...
	ld	a, (de)
	ld	(hl), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:85: set_bkg_data(first_tile, n_tiles, tiles->data);
	ld	l, c
	ld	h, b
	inc	hl
	ld	a,	(hl+)
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:89: for(i = first_tile; i != last_tile_loaded; ++i) {
	...
	jr	00110$
00103$:
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:96: for(i = 0; i != last_bg_pal_loaded; ++ i) {
	ld	hl, #0x0003
	add	hl, bc
	push	hl
	ld	a, l
	...
	ld	c, #0x00
00113$:
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:97: if (memcmp(ZGB_Fading_BPal + (i * N_PALETTE_COLORS), tiles->pals, tiles->num_pals * PALETTE_SIZE) == 0)
	ldhl	sp,	#9
	ld	a, c
	ld	(hl+), a
	ld	(hl), #0x00
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:96: for(i = 0; i != last_bg_pal_loaded; ++ i) {
	...
	jr	00113$
00106$:
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:101: offset |= (UINT16)(i << 8);
	ldhl	sp,	#9
	ld	b, (hl)
	ldhl	sp,	#0
	ld	a, (hl)
	...
	ld	(hl+), a
	ld	(hl), b
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:103: if(i == last_bg_pal_loaded) {
	ld	a, (#_last_bg_pal_loaded)
	sub	a, c
	jr	NZ, 00108$
...
_UpdateMapTile::
	add	sp, #-3
	ld	c, e
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:117: UINT8* addr = (bg_or_win == TARGET_BKG) ? get_bkg_xy_addr(x, y) : get_win_xy_addr(x, y);
	or	a, a
	jr	NZ, 00106$
	ldhl	sp,	#5
	ld	e, (hl)
...
00109$:
	...
	ldhl	sp,	#8
	add	a, (hl)
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/include/Scroll.h:165: set_vram_byte(addr, t);
	pop	de
	push	de
	call	_set_vram_byte
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/include/Scroll.h:167: if (_cpu == CGB_TYPE) {
	ld	a, (#__cpu)
	sub	a, #0x11
	jr	NZ, 00104$
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/include/Scroll.h:168: VBK_REG = 1;
	ld	a, #0x01
	ldh	(_VBK_REG + 0), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/include/Scroll.h:169: set_vram_byte(addr, c);
	ld	a, c
	pop	de
	push	de
	call	_set_vram_byte
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/include/Scroll.h:170: VBK_REG = 0;
	ld	a, #0x00
	ldh	(_VBK_REG + 0), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:122: ScrollSetAttrTileAddr(addr, (UINT8)map_offset + data, (attr) ? *attr : (UINT8)(map_offset >> 8) + scroll_tile_info[(UINT8)map_offset + data]);
00104$:
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:291: __save = CURRENT_BANK;
	ldh	a, (__current_bank + 0)
	ld	(#_ScrollUpdateRow___save_10001_357),a
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:300: SWITCH_ROM(__save);
	ld	a, (_ScrollUpdateRow___save_10001_357)
	ldh	(__current_bank + 0), a
	ld	(#_rROMB0),a
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:343: __save = CURRENT_BANK;
	ldh	a, (__current_bank + 0)
	ld	(#_ScrollUpdateColumn___save_10001_372),a
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:352: SWITCH_ROM(__save);
	ld	a, (_ScrollUpdateColumn___save_10001_372)
	ldh	(__current_bank + 0), a
	ld	(#_rROMB0),a
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:370: __save = CURRENT_BANK;
	ldh	a, (__current_bank + 0)
	ld	(#_MoveScroll___save_10000_383),a
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:373: current_column = PX_TO_TILE(scroll_x);
	ld	a, (#_scroll_x)
	ld	(#_MoveScroll_current_column_10000_383),a
	ld	a, (#_scroll_x + 1)
	ld	hl, #_MoveScroll_current_column_10000_383 + 1
	ld	(hl), a
	sra	(hl)
	dec	hl
	rr	(hl)
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:374: current_row    = PX_TO_TILE(scroll_y);
	ld	a, (#_scroll_y)
	ld	(#_MoveScroll_current_row_10000_383),a
	ld	a, (#_scroll_y + 1)
	ld	hl, #_MoveScroll_current_row_10000_383 + 1
	ld	(hl), a
	sra	(hl)
	dec	hl
	rr	(hl)
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:380: new_column     = PX_TO_TILE(scroll_x);
	ld	a, (#_scroll_x)
	ld	(#_MoveScroll_new_column_10000_383),a
	ld	a, (#_scroll_x + 1)
	ld	hl, #_MoveScroll_new_column_10000_383 + 1
	ld	(hl), a
	sra	(hl)
	dec	hl
	rr	(hl)
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:381: new_row        = PX_TO_TILE(scroll_y);
	ld	a, (#_scroll_y)
	ld	(#_MoveScroll_new_row_10000_383),a
	ld	a, (#_scroll_y + 1)
	ld	hl, #_MoveScroll_new_row_10000_383 + 1
	ld	(hl), a
	sra	(hl)
	dec	hl
	rr	(hl)
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:383: if (current_column != new_column) {
	ld	a, (#_MoveScroll_current_column_10000_383)
	ld	hl, #_MoveScroll_new_column_10000_383
	sub	a, (hl)
	jr	NZ, 00168$
	ld	a, (#_MoveScroll_current_column_10000_383 + 1)
	ld	hl, #_MoveScroll_new_column_10000_383 + 1
	sub	a, (hl)
	jr	Z, 00105$
00168$:
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:391: if (current_row != new_row) {
	ld	a, (#_MoveScroll_current_row_10000_383)
	ld	hl, #_MoveScroll_new_row_10000_383
	sub	a, (hl)
	jr	NZ, 00171$
	ld	a, (#_MoveScroll_current_row_10000_383 + 1)
	ld	hl, #_MoveScroll_new_row_10000_383 + 1
	sub	a, (hl)
	jr	Z, 00112$
00171$:
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:392: if (new_row > current_row) {
	ld	de, #_MoveScroll_current_row_10000_383
	ld	hl, #_MoveScroll_new_row_10000_383
	ld	a, (de)
	inc	de
	sub	a, (hl)
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Scroll.c:405: SWITCH_ROM(__save);
	ld	a, (_MoveScroll___save_10000_383)
	ldh	(__current_bank + 0), a
	ld	(#_rROMB0),a

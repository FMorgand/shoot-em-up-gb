...
_main::
	dec	sp
	dec	sp
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/main.c:49: for (UINT8 i = 4; i != 0; i--) vsync();
	ld	c, #0x04
00126$:
	ld	a, c
	or	a, a
	...
	jr	00126$
00101$:
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/main.c:51: _is_SGB = sgb_check();
	call	_sgb_check
	ld	hl, #__is_SGB
	ld	(hl), e
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/main.c:53: cpu_fast();
	call	_cpu_fast
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/main.c:63: InitOAMs();
	call	_InitOAMs
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/include/Sound.h:35: NR52_REG = SFX_CH_ENABLE, NR51_REG = 0xFF, NR50_REG = 0x77;  // enable sound
	ld	a, #0x80
	ldh	(_NR52_REG + 0), a
	ld	a, #0xff
	ldh	(_NR51_REG + 0), a
	ld	a, #0x77
	ldh	(_NR50_REG + 0), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/include/Sound.h:75: NR12_REG = NR22_REG = NR32_REG = NR42_REG = 0;
	xor	a, a
	ldh	(_NR42_REG + 0), a
	xor	a, a
	ldh	(_NR32_REG + 0), a
	...
	xor	a, a
	ldh	(_NR12_REG + 0), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/include/Sound.h:76: NR14_REG = NR24_REG = NR44_REG = SFX_CH_RETRIGGER;
	ld	a, #0xc0
	ldh	(_NR44_REG + 0), a
	ld	a, #0xc0
	ldh	(_NR24_REG + 0), a
	ld	a, #0xc0
	ldh	(_NR14_REG + 0), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/include/Sound.h:77: NR51_REG = 0xFF;
	ld	a, #0xff
	ldh	(_NR51_REG + 0), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/include/Music.h:87: }
	di
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/include/Music.h:77: TMA_REG = (_cpu == CGB_TYPE) ? 0x78u : 0xBCu;
	ld	a, (#__cpu)
	sub	a, #0x11
	ld	a, #0x78
	jr	Z, 00131$
...
00131$:
	ldh	(_TMA_REG + 0), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/include/Music.h:81: TAC_REG = 0x04u;
	ld	a, #0x04
	ldh	(_TAC_REG + 0), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/include/Music.h:82: add_low_priority_TIM(MUSIC_isr);
	ld	de, #_MUSIC_isr
	call	_add_low_priority_TIM
	ei
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/include/Music.h:89: set_interrupts(IE_REG | TIM_IFLAG);
	ldh	a, (_IE_REG + 0)
	set	2, a
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/main.c:82: SHOW_SPRITES; SHOW_BKG;
	...
	or	a, #0x01
	ldh	(_LCDC_REG + 0), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/main.c:84: WY_REG = (UINT8)(DEVICE_WINDOW_PX_OFFSET_Y + DEVICE_SCREEN_PX_HEIGHT);
	ld	a, #0x90
	ldh	(_WY_REG + 0), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/main.c:90: SetDefaultColorPalettes();
	...
	call	___sdcc_bcall_ehl
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/main.c:93: DISPLAY_OFF;
	call	_display_off
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/main.c:94: while(TRUE) {
00118$:
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/main.c:96: if (fade_mode != FADE_MANUAL) {
	ld	a, (#_fade_mode)
	sub	a, #0x02
	jr	Z, 00103$
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/main.c:97: BGP_REG = OBP0_REG = DMG_PALETTE(DMG_WHITE, DMG_LITE_GRAY, DMG_DARK_GRAY, DMG_BLACK);
	ld	a, #0xe4
	ldh	(_OBP0_REG + 0), a
	ld	a, #0xe4
	ldh	(_BGP_REG + 0), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/main.c:98: OBP1_REG = DMG_PALETTE(DMG_WHITE, DMG_WHITE, DMG_DARK_GRAY, DMG_BLACK);
	ld	a, #0xe0
	ldh	(_OBP1_REG + 0), a
00103$:
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/main.c:115: scroll_y_vblank = scroll_offset_y = 0;
	...
	ld	(hl+), a
	ld	(hl), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/main.c:117: HIDE_HUD;                                       // force hiding HUD
	xor	a, a
	push	af
	inc	sp
	ld	e, #0x00

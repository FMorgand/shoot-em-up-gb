...
;--------------------------------------------------------
	.area _DATA
_DrawSprite_screen_x_10000_298:
	.ds 2
_DrawSprite_screen_y_10000_298:
	.ds 2
;--------------------------------------------------------
; ram data
;--------------------------------------------------------
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Sprite.c:29: sprite->first_tile_HV = spriteIdxsHV[sprite_type];
	...
	ld	a, (hl)
	ld	(de), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Sprite.c:31: sprite->attr_add = (_cpu == CGB_TYPE) ? spritePalsOffset[sprite_type] : 0;
	ldhl	sp,#7
	ld	a, (hl+)
	ld	e, a
	ld	d, (hl)
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Sprite.c:74: screen_x = THIS->x - scroll_x;
	...
	ld	a, c
	sub	a, e
	ld	hl, #_DrawSprite_screen_x_10000_298
	ld	(hl+), a
	ld	a, b
	sbc	a, d
	ld	(hl), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Sprite.c:75: screen_y = THIS->y - scroll_y;
	...
	ld	a, c
	sub	a, e
	ld	hl, #_DrawSprite_screen_y_10000_298
	ld	(hl+), a
	ld	a, b
	sbc	a, d
	ld	(hl), a
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Sprite.c:110: case NO_MIRROR: next_oam_idx += move_metasprite_ex    (THIS->mt_sprite, THIS->first_tile,    THIS->attr_add, next_oam_idx, screen_x,                screen_y               ); break;
	ld	a, (#_DrawSprite_screen_y_10000_298)
	ldhl	sp,	#2
	ld	(hl), a
	ld	a, (#_DrawSprite_screen_x_10000_298)
	ldhl	sp,	#3
	ld	(hl), a
	ld	a, (#_next_oam_idx)
	ldhl	sp,	#4
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/Sprite.c:110: case NO_MIRROR: next_oam_idx += move_metasprite_ex    (THIS->mt_sprite, THIS->first_tile,    THIS->attr_add, next_oam_idx, screen_x,                screen_y               ); break;
	...
	inc	de
	ld	a, (de)
;c:\users\franc\documents\projets\perso\gameboyprojects\gbdk\include\gb\metasprites.h:160: __current_metasprite = metasprite;
	ld	(hl-), a
	ld	a, (hl+)
	inc	hl
	ld	(hl-), a
...
;c:\users\franc\documents\projets\perso\gameboyprojects\gbdk\include\gb\metasprites.h:163: return __move_metasprite(base_sprite, (y << 8) | (uint8_t)x);
	ldhl	sp,	#4
	ld	a, (hl)
...
00111$:
	...
	ldhl	sp,	#4
	ld	l, (hl)
;c:\users\franc\documents\projets\perso\gameboyprojects\gbdk\include\gb\metasprites.h:241: __current_metasprite = metasprite;
	ld	(___current_metasprite), a
	ld	a, c
	ld	(___current_metasprite + 1), a
;c:\users\franc\documents\projets\perso\gameboyprojects\gbdk\include\gb\metasprites.h:244: return __move_metasprite_flipy(base_sprite, ((y - ((LCDC_REG & LCDCF_OBJ16) ? 16u : 8u)) << 8) | x);
	push	de
	ldh	a, (_LCDC_REG + 0)
	ld	c, a
	pop	af
...
00112$:
	...
	ld	a, (hl)
	ld	(#___current_base_tile),a
;c:\users\franc\documents\projets\perso\gameboyprojects\gbdk\include\gb\metasprites.h:200: __current_metasprite = metasprite;
	ldhl	sp,	#14
	ld	a, (hl)
	ld	(#___current_metasprite),a
	ldhl	sp,	#15
	ld	a, (hl)
	ld	(#___current_metasprite + 1),a
;c:\users\franc\documents\projets\perso\gameboyprojects\gbdk\include\gb\metasprites.h:203: return __move_metasprite_flipx(base_sprite, (y << 8) | (uint8_t)(x - 8u));
	ldhl	sp,	#13
	ld	d, (hl)
	ld	a, e
	add	a, #0xf8
...
00114$:
	...
	ldhl	sp,	#4
	ld	c, (hl)
;c:\users\franc\documents\projets\perso\gameboyprojects\gbdk\include\gb\metasprites.h:281: __current_metasprite = metasprite;
	ld	hl, #___current_metasprite
	ld	(hl+), a
	ld	(hl), b
;c:\users\franc\documents\projets\perso\gameboyprojects\gbdk\include\gb\metasprites.h:284: return __move_metasprite_flipxy(base_sprite, ((y - ((LCDC_REG & LCDCF_OBJ16) ? 16u : 8u)) << 8) | (uint8_t)(x - 8));
	ldhl	sp,	#15
	ld	b, (hl)
	ldh	a, (_LCDC_REG + 0)
	bit	2, a

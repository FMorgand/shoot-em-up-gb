...
;--------------------------------------------------------
	.area _DATA
_FadeDMG_colors_10000_282:
	.ds 12
_ZGB_Fading_BPal::
	.ds 64
_ZGB_Fading_SPal::
	.ds 64
_FadeStepColor_palette_10000_318:
	.ds 64
_FadeStepColor_palette_s_10000_318:
	.ds 64
;--------------------------------------------------------
; ram data
;--------------------------------------------------------
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:17: UINT8* c = colors;
	ld	(hl+), a
	ld	(hl), #<(_FadeDMG_colors_10000_282)
	inc	hl
	ld	(hl), #>(_FadeDMG_colors_10000_282)
...
_pals:
	...
	.dw _OBP0_REG
	.dw _OBP1_REG
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:43: palette_color_t UpdateColor(UINT8 i, UWORD col) {
;	---------------------------------
...
_UpdateColor::
	...
	ld	(hl+), a
	ld	(hl), d
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:44: return RGB(PAL_RED(col) | DespRight(0x1F, 5 - i), PAL_GREEN(col) | DespRight(0x1F, 5 - i), PAL_BLUE(col) | DespRight(0x1F, 5 - i));
	ld	a, (hl)
	rrca
	rrca
	and	a, #0x1f
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:44: return RGB(PAL_RED(col) | DespRight(0x1F, 5 - i), PAL_GREEN(col) | DespRight(0x1F, 5 - i), PAL_BLUE(col) | DespRight(0x1F, 5 - i));
	...
	or	a, c
	ld	c, a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:45: }
	add	sp, #4
	ret
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:47: void FadeStepColor(UINT8 i) {
;	---------------------------------
...
_FadeStepColor::
	add	sp, #-8
	ldhl	sp,	#2
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:50: palette_color_t* col = ZGB_Fading_BPal;
	ld	(hl+), a
	ld	a, #<(_ZGB_Fading_BPal)
	ld	(hl+), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:51: palette_color_t* col_s = ZGB_Fading_SPal;
	ld	a, #>(_ZGB_Fading_BPal)
	ld	(hl+), a
	ld	a, #<(_ZGB_Fading_SPal)
	ld	(hl+), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:53: for(UINT8 c = 0; c < 32; ++c, ++col, ++col_s) {
	ld	a, #>(_ZGB_Fading_SPal)
	ld	(hl+), a
	ld	(hl), #0x00
00103$:
	...
	sub	a, #0x20
	jr	NC, 00101$
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:54: palette[c] = UpdateColor(i, *col);
	ld	c, (hl)
	xor	a, a
	sla	c
	adc	a, a
	...
	pop	de
	push	de
	ld	hl, #_FadeStepColor_palette_10000_318
	add	hl, de
	ld	c, l
	ld	b, h
	ldhl	sp,#3
	...
	ld	a, d
	ld	(bc), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:55: palette_s[c] = UpdateColor(i, *col_s);
	pop	de
	push	de
	ld	hl, #_FadeStepColor_palette_s_10000_318
	add	hl, de
	ld	c, l
	ld	b, h
	ldhl	sp,#5
...
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:53: for(UINT8 c = 0; c < 32; ++c, ++col, ++col_s) {
	...
	jr	00103$
00101$:
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:58: SyncVBlank();
	call	_SyncVBlank
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:59: set_bkg_palette(0, 8, palette);
	ld	de, #_FadeStepColor_palette_10000_318
	push	de
	ld	hl, #0x800
	push	hl
	call	_set_bkg_palette
	add	sp, #4
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:60: set_sprite_palette(0, 8, palette_s);
	ld	de, #_FadeStepColor_palette_s_10000_318
	push	de
	ld	hl, #0x800
	push	hl
	call	_set_sprite_palette
	add	sp, #4
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:61: DISPLAY_ON;
	ldh	a, (_LCDC_REG + 0)
	or	a, #0x80
	ldh	(_LCDC_REG + 0), a
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:62: SyncVBlank();
	call	_SyncVBlank
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:63: }
	add	sp, #8
	ret
...
; ---------------------------------
	b_FadeIn	= 1
_FadeIn::
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:68: if (_cpu == CGB_TYPE) {
	ld	hl, #__cpu
	ld	a, (hl)
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:69: for(UINT8 i = 0; i != 6; i ++) FadeStepColor(i);
	sub	a, #0x11
	jr	NZ, 00103$
	ld	c, a
00106$:
...
; ---------------------------------
	b_FadeOut	= 1
_FadeOut::
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:81: if (_cpu == CGB_TYPE) {
	ld	a, (#__cpu)
	sub	a, #0x11
	jr	NZ, 00103$
;C:/Users/franc/Documents/Projets/Perso/GameBoyProjects/CrossZGB/common/src/gb/Fade.c:82: for(UINT8 i = 5; i != 0xFF; -- i) FadeStepColor(i);	
	ld	c, #0x05
00106$:
	ld	a, c
	inc	a
